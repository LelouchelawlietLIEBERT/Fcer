...
.grid-container {
  ...
  .plane {
    ...
    &>* {
      ...
      &::before {
        background-image: repeating-linear-gradient(to left, red, red 4px, transparent 4px, transparent var(--grid)),
          repeating-linear-gradient(to bottom, red, red 4px, transparent 4px, transparent var(--grid));
